...
<section class="products">
  <div class="product-list">
    <?php
    $products = [
      ["id" => 1, "img" => "img/natu1-naname.png", "name" => "黒靴", "price" => 2500],
      ["id" => 2, "img" => "img/natu2-naname.png", "name" => "サンダル", "price" => 3200],
      ["id" => 3, "img" => "img/natu3-naname.png", "name" => "白靴", "price" => 2800],
      ["id" => 4, "img" => "img/natu4-naname.png", "name" => "カラフルサンダル", "price" => 3000]
    ];
